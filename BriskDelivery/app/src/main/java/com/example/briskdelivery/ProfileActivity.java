...
public class ProfileActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rListBtn.setOnClickListener((View v) -> {
            ...
            startActivity(new Intent(com.example.briskdelivery.ProfileActivity.this, com.example.briskdelivery.RestaurantList.class));
        ...
        oHisbtn.setOnClickListener((View v) -> {
            ...
            startActivity(new Intent(ProfileActivity.this, com.example.briskdelivery.OrderDetail.class));

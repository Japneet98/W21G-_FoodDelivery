...
//    final static String Invite = "Invite";
    ...
    final static String UFName = "FName";
    final static String ULName = "LName";
...
//                        " where "+ User +"."+ UId + "=" + id;
    ...
    public boolean updateUser(User user){
      ...
      //  values.put(T3COL_7, user.getZIPCode());
        values.put(UPassword, user.getPassword());
        long r = db.update(User,values, " UserId="+user.getUserId(), null);
        if(r == -1){
            return false;
        }else{
            return true;

...
//   List<String> list = new ArrayList<>(Arrays.asList("KFC",
//          "Subway", "Ice and Spice"));
//   List<Integer> pic = new ArrayList<>(Arrays.asList(R.drawable.pinchofspice,
//          R.drawable.subway, R.drawable.iceandspice));
